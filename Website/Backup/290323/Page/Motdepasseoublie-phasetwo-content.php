...
<section class="forget_compte_section_ph2 p-5">
  <div class="container-fluid text-center">
    ...
    <form method="POST" id="formpasswordforgetph2" class="needs-validation" action="Motdepasseoublie-phasetwo.php"
      ...
      <div class="row col-sm-4 mx-auto" style="margin-bottom: 1rem;">
        ...
        <input type="password" class="form-control"
          ...
          value="<?php echo (isset($_POST['forget_password_ph2'])) ? htmlspecialchars($_POST['forget_password_ph2']) : '' ?>"
          placeholder="************" name="forget_password_ph2" id="forget_password_ph2" required>
      ...
      <div class="row col-sm-4 mx-auto" style="margin-bottom: 1rem;">
        ...
        <input type="password" class="form-control"
          pattern="^(?=.*\d)(?=.*[A-Z])(?=.*[a-z])(?=.*[^\w\d\s:])([^\s]){8,16}$"
          value="<?php echo (isset($_POST['forget_password_ph2_conf'])) ? htmlspecialchars($_POST['forget_password_ph2_conf']) : '' ?>"
          placeholder="************" name="forget_password_ph2_conf" id="forget_password_ph2_conf" required>
        <div class="invalid-feedback">
          Vous devez entrer un mot de passe valide !
        </div>
      </div>
      ...
      <div style="margin-bottom: 1rem;">
        <button type="submit" name="submit_forget_form_ph2" class="btn reserve-btn ms-3"
