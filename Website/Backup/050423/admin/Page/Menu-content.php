                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" data-id="<?php echo $menu['menu_id']; ?>"
                          class="btn btn-warning delete_menu_button" id="delete_menu_button"
        ...
        <div class="form-add-product">
          ...
          <div class="form-add-product-body">
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z0-9éèê^]/g,'');"
                value="<?php echo (isset($_POST['menu_name'])) ? htmlspecialchars($_POST['menu_name']) : '' ?>"
                placeholder="Menu du marché" name="menu_name">
              <?php
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z0-9éèê^]/g,'');"
                value="<?php echo (isset($_POST['menu_f_options'])) ? htmlspecialchars($_POST['menu_f_options']) : '' ?>"
                placeholder="Formule du midi" name="menu_f_options">
              <?php
                $check_add_menu_form = 0;
                if (isset($_POST['add_new_menu'])) {
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <textarea class="form-control" name="menu_f_description" style="resize: none;"
                placeholder="Du lundi au vendredi, entrée + plat + dessert"><?php echo (isset($_POST['menu_f_description'])) ? htmlspecialchars($_POST['menu_f_description']) : ''; ?></textarea>
              <?php
                if (isset($_POST['add_new_menu'])) {
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <input type="text" class="form-control"
                value="<?php echo (isset($_POST['menu_f_price'])) ? htmlspecialchars($_POST['menu_f_price']) : '' ?>"
                placeholder="30.00" name="menu_f_price">
              <?php
                if (isset($_POST['add_new_menu'])) {
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Zéèê^0-9]/g,'');"
                value="<?php echo (isset($_POST['menu_s_options'])) ? htmlspecialchars($_POST['menu_s_options']) : '' ?>"
                placeholder="Formule du soir" name="menu_s_options">
            </div>
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <textarea class="form-control" name="menu_s_description" style="resize: none;"
                placeholder="Du lundi au vendredi, entrée + plat + dessert"><?php echo (isset($_POST['menu_s_description'])) ? htmlspecialchars($_POST['menu_s_description']) : ''; ?></textarea>
              <?php
                if (isset($_POST['add_new_menu'])) {
...
Swal.fire("Validé", "Le nouveau menu a bien été ajouté !", "success").then((value) => {
...
<div style="padding:20px">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="Menu.php?do=Modify&menu_id=<?php echo $menu['menu_id'] ?>"
        ...
        <div class="form-add-product">
          ...
          <div class="form-add-product-body">
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_name">Nom du menu</label>
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z0-9éèê^]/g,'');"
                value="<?php echo $menu['menu_name'] ?>" placeholder="Sushi au thon" name="menu_name">
              <?php
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_f_options">Nom de la formule 1</label>
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z0-9éèê^]/g,'');"
                value="<?php echo $menu['menu_f_options'] ?>" placeholder="Formule du midi" name="menu_f_options">
              <?php
                    $check_modify_menu_form = 0;
                    if (isset($_POST['modify_menu_sbmt'])) {
                      if (empty(test_input($_POST['menu_f_options']))) {
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <textarea class="form-control" name="menu_f_description" style="resize: none;"
                placeholder="Du lundi au vendredi, entrée + plat + dessert"><?php echo $menu['menu_f_description']; ?></textarea>
              <?php
                    if (isset($_POST['modify_menu_sbmt'])) {
                      if (empty(test_input($_POST['menu_f_description']))) {
                    ?>
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_f_price">Prix de la formule 1 (€)</label>
              <input type="text" class="form-control" value="<?php echo $menu['menu_f_price'] ?>" placeholder="30.00"
                name="menu_f_price">
              <?php
                    if (isset($_POST['modify_menu_sbmt'])) {
                      if (empty(test_input($_POST['menu_f_price']))) {
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_s_options">Nom de la formule 2</label>
              <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z0-9éèê^]/g,'');"
                value="<?php echo $menu['menu_s_options'] ?>" placeholder="Formule du soir" name="menu_s_options">
              <?php
                    $check_modify_menu_form = 0;
                    ?>
            </div>
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_s_description">Description de la formule 2</label>
              <textarea class="form-control" name="menu_s_description" style="resize: none;"
                placeholder="Du lundi au vendredi, entrée + plat + dessert"><?php echo $menu['menu_s_description']; ?></textarea>
              <?php
                    if (isset($_POST['modify_menu_sbmt'])) {
                      if (strlen(test_input($_POST['menu_s_description'])) > 255) {
                    ?>
            ...
            <div style="margin-bottom: 1rem;">
              <label for="menu_s_price">Prix de la formule 2 (€)</label>
              <input type="text" class="form-control" value="<?php echo $menu['menu_s_price'] ?>" placeholder="40.00"
                name="menu_s_price">
            </div>

            <button type="submit" name="modify_menu_sbmt" class="btn btn-info float-end"
              style="border-radius: 30px; color: white;">
              Modifier le menu
            </button>
          </div>
...
<script type="text/javascript">
Swal.fire("Validé", "Le menu a bien été modifié", "success").then((value) => {
  window.location.replace("Menu.php");
});
</script>
