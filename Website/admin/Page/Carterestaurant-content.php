          ...
          <div class="form-add-product">
            ...
            <div class="form-add-product-body">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="text" class="form-control" value="<?php echo (isset($_POST['product_name'])) ? htmlspecialchars($_POST['product_name']) : '' ?>" placeholder="Sushi au thon" name="product_name">
                <?php
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <div class="picture-upload">
                  <div class="picture-edit">
                    <input type='file' name="product_picture" id="add_product_pictUpload" accept=".png, .jpg, .jpeg" />
                    <label for="add_product_pictUpload"></label>
                  </div>
                  <div class="picture-preview">
                    <div id="add_product_pictPreview">
                    </div>
                  </div>
                </div>
                <?php
              ...
              <button type="submit" name="add_new_product" class="btn btn-info float-end" style="border-radius: 30px; color: white;">
                Ajouter le produit
              </button>
            </div>
          </div>
            ...
            <form method="POST" action="Carterestaurant.php?do=Modify&product_id=<?php echo $product['product_id'] ?>" enctype="multipart/form-data">
              <div class="form-add-product">
                ...
                <div class="form-add-product-body">
                  ...
                  <div style="margin-bottom: 1rem;">
                    <label for="product_name">Nom du produit</label>
                    <input type="text" class="form-control" value="<?php echo $product['product_name'] ?>" placeholder="Sushi au thon" name="product_name">
                    <?php
                  ...
                  <button type="submit" name="modify_product_sbmt" class="btn btn-info float-end" style="border-radius: 30px; color: white;">
                    Modifier le produit
                  </button>
                </div>
              </div>
