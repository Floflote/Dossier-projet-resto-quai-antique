...
<div style="padding:20px">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <button class="btn btn-success btn-sm" style="margin-bottom: 10px; border-radius: 30px;" type="button"
        data-bs-toggle="modal" data-bs-target="#add_new_picture_modal">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div style="margin-bottom: 1rem;">
                  ...
                  <input type="text" id="picture_name_input" class="form-control"
                    onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="Sushi au saumon"
                    name="picture_name">
                  <?php
                ...
                <div style="margin-bottom: 1rem;">
                  ...
                  <div class="picture-upload">
                    <div class="picture-edit">
                      <input type='file' name="picture_image" id="add_gallery_pictureUpload"
                        accept=".png, .jpg, .jpeg" />
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-danger" style="border-radius: 30px;"
                          data-bs-dismiss="modal">Annuler</button>
                        <button type="button" data-id="<?php echo $picture['picture_id']; ?>"
                          class="btn btn-warning delete_picture_bttn" id="delete_picture_bttn"
...
Swal.fire("Validé", "La nouvelle image a bien été ajoutée !", "success").then((value) => {
