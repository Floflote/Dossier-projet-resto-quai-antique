...
(11, '2023-04-22', '12:53:00', 2, 'testresa@mail.com', 'Non');
...
(21, 'saturday_lunch_start', 'Samedi début déjeuner', '12:23:00'),
(22, 'saturday_lunch_end', 'Samedi fin déjeuner', '15:12:00'),
(23, 'saturday_diner_start', 'Samedi début diner', '00:00:00'),
(24, 'saturday_diner_end', 'Samedi fin diner', '00:00:00'),
(25, 'sunday_lunch_start', 'Dimanche début déjeuner', '00:00:00'),
(26, 'sunday_lunch_end', 'Dimanche fin déjeuner', '00:00:00'),
(27, 'sunday_diner_start', 'Dimanche début diner', '18:25:00'),
(28, 'sunday_diner_end', 'Dimanche fin diner', '22:34:00');
...
(5, 'restaurant_nbcustomers', 'Nombre de réservations par service', '3');
...
--
ALTER TABLE `reservation`
  MODIFY `reservation_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
